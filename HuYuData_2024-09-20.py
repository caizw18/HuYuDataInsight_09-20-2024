...
# Print the results
print(f"Johnson & Johnson (JNJ) Current Stock Price: {S:.2f}")
...
# Johnson & Johnson (JNJ) Current Stock Price: 168.43
# Strike Price: 165
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.22
# Call Option Price: 10.32
